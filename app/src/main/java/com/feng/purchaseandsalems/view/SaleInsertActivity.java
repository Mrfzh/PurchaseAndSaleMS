...
public class SaleInsertActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.activity_sale_insert;
    }
    ...
    protected void initView() {
        mBackIv = findViewById(R.id.iv_sale_insert_back);
        mBackIv.setOnClickListener(this);
        mInsertBtn = findViewById(R.id.btn_sale_insert_insert);
        mInsertBtn.setOnClickListener(this);

        mAutopartsIdEt = findViewById(R.id.et_sale_insert_autoParts_id);
        mNumEt = findViewById(R.id.et_sale_insert_num);
        mCustomerNameEt = findViewById(R.id.et_sale_insert_customer_name);
        mCustomerContactEt = findViewById(R.id.et_sale_insert_customer_contact);
        mStaffIdEt = findViewById(R.id.et_sale_insert_staff_id);

        mProgressBar = findViewById(R.id.pb_sale_insert);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_sale_insert_back:
                finish();
                break;
            case R.id.btn_sale_insert_insert:
                if (!checkInsert()) {
                    break;
                }
                mProgressBar.setVisibility(View.VISIBLE);
                SoftInputUtil.hideSoftInput(SaleInsertActivity.this);
                // 插入销售信息
                final SaleData saleData = new SaleData(
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        SaleOperation.insertSale(saleData, new OperationListener() {
                            @Override
                            public void success() {
